--TEST--
/home/weyrick/pcc/tests/zcreate_function.php (converted from Roadsend suite)
--FILE--
<?php
...
Using the first array of anonymous functions
parameters: 2.3445, M_PI
some trig: -1.62917250578
a hypotenuse: 3.9199852871
b*a^2 = 4.81033133145
min(b^2+a, a^2,b) = 8.63827290359
ln(a)/b = 0.271222992126
