--TEST--
/home/weyrick/pcc/bugs/tests/bug-id-0001845.php (converted from Roadsend suite)
--FILE--
<?php
...
property 'require_once': require_once
...
property 'while': while
property 'do': do
property 'or': or
property 'xor': xor
property 'and': and
property 'endwhile': endwhile
property 'endif': endif
property 'for': for
property 'foreach': foreach
property 'as': as
property 'unset': unset
