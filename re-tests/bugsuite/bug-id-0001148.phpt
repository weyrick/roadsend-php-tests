--TEST--
/home/weyrick/pcc/bugs/tests/bug-id-0001148.php (converted from Roadsend suite)
--FILE--
 <?php
...
function test($v1, $v2) {
    print "in php, checking $v1 against $v2\n";
...
1 < 2
in php, checking 10 against 2
10 > 2
in php, checking 1.0 against 1.1
1.0 < 1.1
in php, checking 1.2 against 1.0.1
1.2 > 1.0.1
in php, checking 1.0-dev against 1.0-dev
1.0-dev = 1.0-dev
in php, checking 1.0-dev against 1.0a1
1.0-dev < 1.0a1
in php, checking 1.0-dev against 1.0b1
1.0-dev < 1.0b1
in php, checking 1.0-dev against 1.0RC1
1.0-dev < 1.0RC1
in php, checking 1.0-dev against 1.0
1.0-dev < 1.0
in php, checking 1.0-dev against 1.0pl1
1.0-dev < 1.0pl1
in php, checking 1.0a1 against 1.0-dev
1.0a1 > 1.0-dev
in php, checking 1.0a1 against 1.0a1
1.0a1 = 1.0a1
in php, checking 1.0a1 against 1.0b1
1.0a1 < 1.0b1
in php, checking 1.0a1 against 1.0RC1
1.0a1 < 1.0RC1
in php, checking 1.0a1 against 1.0
1.0a1 < 1.0
in php, checking 1.0a1 against 1.0pl1
1.0a1 < 1.0pl1
in php, checking 1.0b1 against 1.0-dev
1.0b1 > 1.0-dev
in php, checking 1.0b1 against 1.0a1
1.0b1 > 1.0a1
in php, checking 1.0b1 against 1.0b1
1.0b1 = 1.0b1
in php, checking 1.0b1 against 1.0RC1
1.0b1 < 1.0RC1
in php, checking 1.0b1 against 1.0
1.0b1 < 1.0
in php, checking 1.0b1 against 1.0pl1
1.0b1 < 1.0pl1
in php, checking 1.0RC1 against 1.0-dev
1.0RC1 > 1.0-dev
in php, checking 1.0RC1 against 1.0a1
1.0RC1 > 1.0a1
in php, checking 1.0RC1 against 1.0b1
1.0RC1 > 1.0b1
in php, checking 1.0RC1 against 1.0RC1
1.0RC1 = 1.0RC1
in php, checking 1.0RC1 against 1.0
1.0RC1 < 1.0
in php, checking 1.0RC1 against 1.0pl1
1.0RC1 < 1.0pl1
in php, checking 1.0 against 1.0-dev
1.0 > 1.0-dev
in php, checking 1.0 against 1.0a1
1.0 > 1.0a1
in php, checking 1.0 against 1.0b1
1.0 > 1.0b1
in php, checking 1.0 against 1.0RC1
1.0 > 1.0RC1
in php, checking 1.0 against 1.0
1.0 = 1.0
in php, checking 1.0 against 1.0pl1
1.0 < 1.0pl1
in php, checking 1.0pl1 against 1.0-dev
1.0pl1 > 1.0-dev
in php, checking 1.0pl1 against 1.0a1
1.0pl1 > 1.0a1
in php, checking 1.0pl1 against 1.0b1
1.0pl1 > 1.0b1
in php, checking 1.0pl1 against 1.0RC1
1.0pl1 > 1.0RC1
in php, checking 1.0pl1 against 1.0
1.0pl1 > 1.0
in php, checking 1.0pl1 against 1.0pl1
1.0pl1 = 1.0pl1
TESTING OPERATORS
